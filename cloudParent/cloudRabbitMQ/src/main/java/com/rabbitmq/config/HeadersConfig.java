...
public class HeadersConfig {
    ...
    public Binding bindingCreditBExchanage(Queue creditFianceQueue,HeadersExchange creditFinanceExchange){
        Map<String,Object> headerValues=new HashMap<String,Object>();
        headerValues.put("type","cash");
        headerValues.put("aging","fast");
        return BindingBuilder.bind(creditFianceQueue).to(creditFinanceExchange).whereAny(headerValues).match();
